...
while read line; do
  ...
  # Run_km
  bash run_km2.sh ${R1} ${R2} ${THREAD} ~/km_ALL_targets/ALL_targets/Fusion
  bash run_km2.sh ${R1} ${R2} ${THREAD} ~/km_ALL_targets/ALL_targets/DUX4
  bash run_km2.sh ${R1} ${R2} ${THREAD} ~/km_ALL_targets/ALL_targets/SNV
  bash run_km2.sh ${R1} ${R2} ${THREAD} ~/km_ALL_targets/ALL_targets/focal_deletions
  # bash run_km2.sh ${R1} ${R2} ${THREAD} ~/km_ALL_targets/ALL_targets/IGH_fusion
