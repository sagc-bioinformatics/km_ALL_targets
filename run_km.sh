...
if [ -f ${OUTPUTS}/${SAMPLE}/countTable31.jf ]; then
	...
	jellyfish count -m 31 -o ${OUTPUTS}/${SAMPLE}/countTable31.jf -s 100M -t $3 -C -L 2 <(zcat $1) <(zcat $2)
fi

# Run km find mutation
wc -l ${OUTPUTS}/${SAMPLE}/countTable31.jf
km find_mutation ${TARGET_BASE}/ ${OUTPUTS}/${SAMPLE}/countTable31.jf > ${OUTPUTS}/${SAMPLE}/${SAMPLE}_${TARGET_TYPE}.txt
